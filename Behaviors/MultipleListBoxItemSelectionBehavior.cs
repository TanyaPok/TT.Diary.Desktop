...
namespace TT.Diary.Desktop.Behaviors
{
    public class MultipleListBoxItemSelectionBehavior<T> : Behavior<ListBox> where T : Enum
    {
        ...
        public T SelectedItems
        {
            get
            {
                return (T)GetValue(SelectedItemsProperty);
            }
            set
            {
        ...
        public MultipleListBoxItemSelectionBehavior()
        {
        ...
        private void OnListBoxSelectionChanged(object sender, SelectionChangedEventArgs args)
        {
            ...
            int values = AssociatedObject.SelectedItems.Cast<int>().Aggregate((p, c) => p + c);
